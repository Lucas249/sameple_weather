...
class _CircularSliderWidgetState extends State<CircularSliderWidget> with SingleTickerProviderStateMixin {
  ...
  Widget _buildPainter({required Size size}) {
    return CustomPaint(
        painter: _painter, child: SizedBox(width: size.width, height: size.height, child: _buildChildWidget()));
  }
